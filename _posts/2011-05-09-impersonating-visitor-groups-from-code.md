...
author: Mark Everard
layout: post
guid: http://www.markeverard.com/blog/?p=457
...
categories:
  - Episerver
---
If you require that a particular HttpRequest impersonates one or more Visitor Groups,Â then you can do so by adding one of two keys to the current HttpContext.
