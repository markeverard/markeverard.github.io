...
3. If you want to contribute information from any other Episerver products I&#8217;ve not added (such as Commerce then just [send me a pull-request](https://github.com/markeverard/episerver-cookies/pull/new/master)